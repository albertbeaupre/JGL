...
public class ShortUUIDQueue {
    ...
    /**
     * Constructs a new ShortUUIDQueue object with the specified starting value.
    ...
    public ShortUUIDQueue(int startingValue) {
        this.dequeue = (short) startingValue;
    }
