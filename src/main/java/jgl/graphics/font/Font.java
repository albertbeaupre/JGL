...
public class Font {
    ...
    private ByteBuffer pixelBuffer = ByteBuffer.allocateDirect(INITIAL_BUFFER_CAPACITY);
    private int bufferCapacity = INITIAL_BUFFER_CAPACITY;
    private String text = "";
    private float width;
     ...
     */
    private float[] computeBounds(String text) {
